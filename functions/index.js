...
// Get data from Punsook
exports.copyPretestToSheet = functions.database.ref("/testing/pretest").onUpdate(async change => {
...
exports.copyPosttestToSheet = functions.database.ref("/testing/posttest").onUpdate(async change => {
  let data = change.after.val();
  ...
  */
  ...
  let request = {
    auth: jwtClient,
    spreadsheetId: "1mjmoGcenO3ukD6QcrzPo32cijpdjznXlC7rLfCE4ahM",
    range: "Posttest!A2:W" + maxRange,
    valueInputOption: "RAW",
    requestBody: {
      values: valueArray
    }
